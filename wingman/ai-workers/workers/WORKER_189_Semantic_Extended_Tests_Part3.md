# Worker 189: Semantic Extended Tests Part3
...
- [ ] Create/update file: `wingman/tests/test_integration_189.py`
- [ ] Create test file: `wingman/tests/test_extended_189.py`
- [ ] Implement 3 tests: Tests 260-262
- [ ] Test 260: Risk level edge cases
- [ ] Test 261: Hidden destructive operations
- [ ] Test 262: Benign-looking dangerous commands
...
```bash
cd wingman && pytest tests/test_extended_189.py -v --tb=short
cd wingman && pytest tests/test_extended_189.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "189",
  "worker_name": "Semantic_Extended_Tests_Part3",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_189_retrospective"
  - Namespace: "wingman"
