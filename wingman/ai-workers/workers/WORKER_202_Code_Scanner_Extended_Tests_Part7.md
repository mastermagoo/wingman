# Worker 202: Code Scanner Extended Tests Part7
...
- [ ] Create/update file: `wingman/tests/test_integration_202.py`
- [ ] Create test file: `wingman/tests/test_extended_202.py`
- [ ] Implement 2 tests: Tests 299-300
- [ ] Test 299: Network operations
- [ ] Test 300: Port forwarding
...
```bash
cd wingman && pytest tests/test_extended_202.py -v --tb=short
cd wingman && pytest tests/test_extended_202.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "202",
  "worker_name": "Code_Scanner_Extended_Tests_Part7",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_202_retrospective"
  - Namespace: "wingman"
