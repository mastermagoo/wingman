# Worker 025: Code Scanner - Code Scanner File System Patterns
...
- **Previous workers:** WORKER_024 (prior deliverable complete)
...
```bash
# Validation command for WORKER_025
...
{
  "worker_id": "025",
  "worker_name": "Code_Scanner_File_System_Patterns",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_025_retrospective"
  - Namespace: "wingman"
