# Worker 187: Semantic Extended Tests Part1
...
- [ ] Create/update file: `wingman/tests/test_integration_187.py`
- [ ] Create test file: `wingman/tests/test_extended_187.py`
- [ ] Implement 3 tests: Tests 254-256
- [ ] Test 254: Complex nested instructions
- [ ] Test 255: Multi-step dependencies
- [ ] Test 256: Conditional logic
...
```bash
cd wingman && pytest tests/test_extended_187.py -v --tb=short
cd wingman && pytest tests/test_extended_187.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "187",
  "worker_name": "Semantic_Extended_Tests_Part1",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_187_retrospective"
  - Namespace: "wingman"
