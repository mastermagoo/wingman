# Worker 123: Edge Case Tests 123
...
- [ ] Test 189: OOM during validation
...
```bash
cd wingman && pytest tests/test_edge_cases_123.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_123.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "123",
  "worker_name": "Edge_Case_Tests_123",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_123_retrospective"
  - Namespace: "wingman"
