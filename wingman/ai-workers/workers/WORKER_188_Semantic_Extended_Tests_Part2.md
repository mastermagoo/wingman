# Worker 188: Semantic Extended Tests Part2
...
- [ ] Test 258: Technical jargon
- [ ] Test 259: Domain-specific terms
...
```bash
cd wingman && pytest tests/test_extended_188.py -v --tb=short
cd wingman && pytest tests/test_extended_188.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "188",
  "worker_name": "Semantic_Extended_Tests_Part2",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_188_retrospective"
  - Namespace: "wingman"
