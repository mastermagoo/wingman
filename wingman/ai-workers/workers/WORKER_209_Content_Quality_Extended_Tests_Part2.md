# Worker 209: Content Quality Extended Tests Part2
...
- [ ] Test 320: Insufficient detail
- [ ] Test 321: Ambiguous requirements
...
```bash
cd wingman && pytest tests/test_extended_209.py -v --tb=short
cd wingman && pytest tests/test_extended_209.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "209",
  "worker_name": "Content_Quality_Extended_Tests_Part2",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_209_retrospective"
  - Namespace: "wingman"
