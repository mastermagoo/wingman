# Worker 155: LLM Consistency Test 155
...
```bash
cd wingman && pytest tests/test_llm_consistency_155.py -v --tb=short
cd wingman && pytest tests/test_llm_consistency_155.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "155",
  "worker_name": "LLM_Consistency_Test_155",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_155_retrospective"
  - Namespace: "wingman"
