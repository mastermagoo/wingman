# Worker 150: Performance Test 150
...
```bash
cd wingman && pytest tests/test_performance_150.py -v --tb=short
cd wingman && pytest tests/test_performance_150.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "150",
  "worker_name": "Performance_Test_150",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_150_retrospective"
  - Namespace: "wingman"
