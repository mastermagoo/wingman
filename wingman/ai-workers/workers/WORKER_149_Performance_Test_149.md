# Worker 149: Performance Test 149
...
```bash
cd wingman && pytest tests/test_performance_149.py -v --tb=short
cd wingman && pytest tests/test_performance_149.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "149",
  "worker_name": "Performance_Test_149",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_149_retrospective"
  - Namespace: "wingman"
