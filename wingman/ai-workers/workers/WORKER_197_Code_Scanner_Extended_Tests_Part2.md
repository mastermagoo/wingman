# Worker 197: Code Scanner Extended Tests Part2
...
- [ ] Test 285: Indirect command execution
- [ ] Test 286: Eval/exec patterns
...
```bash
cd wingman && pytest tests/test_extended_197.py -v --tb=short
cd wingman && pytest tests/test_extended_197.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "197",
  "worker_name": "Code_Scanner_Extended_Tests_Part2",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_197_retrospective"
  - Namespace: "wingman"
