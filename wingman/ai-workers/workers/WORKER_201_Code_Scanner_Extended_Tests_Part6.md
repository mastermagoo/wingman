# Worker 201: Code Scanner Extended Tests Part6
...
- [ ] Test 297: Ownership changes
- [ ] Test 298: ACL modifications
...
```bash
cd wingman && pytest tests/test_extended_201.py -v --tb=short
cd wingman && pytest tests/test_extended_201.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "201",
  "worker_name": "Code_Scanner_Extended_Tests_Part6",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_201_retrospective"
  - Namespace: "wingman"
