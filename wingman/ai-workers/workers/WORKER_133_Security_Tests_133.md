...
- [ ] Test 209: SQL injection in task name
...
```bash
cd wingman && pytest tests/test_security_133.py -v --tb=short
cd wingman && pytest tests/test_security_133.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "133",
  "worker_name": "Security_Tests_133",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_133_retrospective"
  - Namespace: "wingman"
