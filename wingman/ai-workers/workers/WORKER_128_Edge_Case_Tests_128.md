# Worker 128: Edge Case Tests 128
...
- [ ] Test 199: Race condition in score calculation
...
```bash
cd wingman && pytest tests/test_edge_cases_128.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_128.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "128",
  "worker_name": "Edge_Case_Tests_128",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_128_retrospective"
  - Namespace: "wingman"
