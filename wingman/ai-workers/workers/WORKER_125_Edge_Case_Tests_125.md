# Worker 125: Edge Case Tests 125
...
- [ ] Test 193: Permission denied (directory)
...
```bash
cd wingman && pytest tests/test_edge_cases_125.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_125.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "125",
  "worker_name": "Edge_Case_Tests_125",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_125_retrospective"
  - Namespace: "wingman"
