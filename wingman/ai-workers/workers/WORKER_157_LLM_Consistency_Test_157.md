# Worker 157: LLM Consistency Test 157
...
```bash
cd wingman && pytest tests/test_llm_consistency_157.py -v --tb=short
cd wingman && pytest tests/test_llm_consistency_157.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "157",
  "worker_name": "LLM_Consistency_Test_157",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_157_retrospective"
  - Namespace: "wingman"
