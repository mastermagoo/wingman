# Worker 152: Performance Test 152
...
```bash
cd wingman && pytest tests/test_performance_152.py -v --tb=short
cd wingman && pytest tests/test_performance_152.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "152",
  "worker_name": "Performance_Test_152",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_152_retrospective"
  - Namespace: "wingman"
