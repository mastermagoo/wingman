...
- [ ] Test 207: Shell command injection
...
```bash
cd wingman && pytest tests/test_security_132.py -v --tb=short
cd wingman && pytest tests/test_security_132.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "132",
  "worker_name": "Security_Tests_132",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_132_retrospective"
  - Namespace: "wingman"
