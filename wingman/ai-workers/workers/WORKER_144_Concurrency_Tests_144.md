# Worker 144: Concurrency Tests 144
...
- [ ] Test 232: Queue message priority
...
```bash
cd wingman && pytest tests/test_concurrency_144.py -v --tb=short
cd wingman && pytest tests/test_concurrency_144.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "144",
  "worker_name": "Concurrency_Tests_144",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_144_retrospective"
  - Namespace: "wingman"
