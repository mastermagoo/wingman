# Worker 146: Concurrency Tests 146
...
```bash
cd wingman && pytest tests/test_concurrency_146.py -v --tb=short
cd wingman && pytest tests/test_concurrency_146.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "146",
  "worker_name": "Concurrency_Tests_146",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_146_retrospective"
  - Namespace: "wingman"
