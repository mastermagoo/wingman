...
- [ ] Test 217: Container escape attempt
- [ ] Test 218: Host access attempt
...
```bash
cd wingman && pytest tests/test_security_137.py -v --tb=short
cd wingman && pytest tests/test_security_137.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "137",
  "worker_name": "Security_Tests_137",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_137_retrospective"
  - Namespace: "wingman"
