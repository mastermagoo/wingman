# Worker 126: Edge Case Tests 126
...
- [ ] Test 195: Rate limit exceeded (API)
...
```bash
cd wingman && pytest tests/test_edge_cases_126.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_126.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "126",
  "worker_name": "Edge_Case_Tests_126",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_126_retrospective"
  - Namespace: "wingman"
