...
```bash
cd wingman && pytest tests/test_e2e_158.py -v --tb=short
cd wingman && pytest tests/test_e2e_158.py --cov --cov-report=term-missing
```
...
- **Store in mem0:**
  - Key: "wingman_worker_158_retrospective"
  - Namespace: "wingman"
