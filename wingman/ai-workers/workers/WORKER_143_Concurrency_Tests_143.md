# Worker 143: Concurrency Tests 143
...
- [ ] Create/update file: `wingman/tests/test_integration_143.py`
- [ ] Create test file: `wingman/tests/test_concurrency_143.py`
- [ ] Implement 2 tests: Tests 229-230
- [ ] Test 229: Lock contention on approval record
- [ ] Test 230: Lock contention on validator state
...
```bash
cd wingman && pytest tests/test_concurrency_143.py -v --tb=short
cd wingman && pytest tests/test_concurrency_143.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "143",
  "worker_name": "Concurrency_Tests_143",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_143_retrospective"
  - Namespace: "wingman"
