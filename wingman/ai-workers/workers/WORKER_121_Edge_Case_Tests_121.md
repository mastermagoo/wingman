# Worker 121: Edge Case Tests 121
...
- [ ] Test 185: LLM returns invalid response
...
```bash
cd wingman && pytest tests/test_edge_cases_121.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_121.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "121",
  "worker_name": "Edge_Case_Tests_121",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_121_retrospective"
  - Namespace: "wingman"
