# Worker 017: Semantic Analyzer - Semantic Tests Error Handling
...
- **Previous workers:** WORKER_016 (prior deliverable complete)
...
{
  "worker_id": "017",
  "worker_name": "Semantic_Tests_Error_Handling",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_017_retrospective"
  - Namespace: "wingman"
