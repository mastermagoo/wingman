# Worker 122: Edge Case Tests 122
...
- [ ] Test 187: Database query timeout
...
```bash
cd wingman && pytest tests/test_edge_cases_122.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_122.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "122",
  "worker_name": "Edge_Case_Tests_122",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_122_retrospective"
  - Namespace: "wingman"
