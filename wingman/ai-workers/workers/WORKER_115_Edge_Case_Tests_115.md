# Worker 115: Edge Case Tests 115
...
- [ ] Test 173: Missing SUCCESS_CRITERIA section
...
```bash
cd wingman && pytest tests/test_edge_cases_115.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_115.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "115",
  "worker_name": "Edge_Case_Tests_115",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_115_retrospective"
  - Namespace: "wingman"
