# Worker 168: Run Validation On Bad Dataset
...
- [ ] Create/update file: `wingman/tests/test_integration_168.py`
- [ ] Run validation on 20 bad instructions
- [ ] Document findings and changes
- [ ] Test results file: `ai-workers/results/worker-168-results.json`

---

## 2. SUCCESS_CRITERIA

- [ ] Collect validation results for all 20 bad instructions
...
{
  "worker_id": "168",
  "worker_name": "Run_Validation_On_Bad_Dataset",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_168_retrospective"
  - Namespace: "wingman"
