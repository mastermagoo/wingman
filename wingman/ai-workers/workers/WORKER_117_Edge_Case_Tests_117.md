# Worker 117: Edge Case Tests 117
...
- [ ] Create/update file: `wingman/tests/test_integration_117.py`
- [ ] Create test file: `wingman/tests/test_edge_cases_117.py`
- [ ] Implement 2 tests: Tests 176-177
- [ ] Test 176: Contradictory requirements
- [ ] Test 177: Conflicting constraints
...
```bash
cd wingman && pytest tests/test_edge_cases_117.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_117.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "117",
  "worker_name": "Edge_Case_Tests_117",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_117_retrospective"
  - Namespace: "wingman"
