...
- [ ] Test 211: Directory traversal attempt
...
```bash
cd wingman && pytest tests/test_security_134.py -v --tb=short
cd wingman && pytest tests/test_security_134.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "134",
  "worker_name": "Security_Tests_134",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_134_retrospective"
  - Namespace: "wingman"
