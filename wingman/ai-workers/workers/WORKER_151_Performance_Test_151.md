# Worker 151: Performance Test 151
...
```bash
cd wingman && pytest tests/test_performance_151.py -v --tb=short
cd wingman && pytest tests/test_performance_151.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "151",
  "worker_name": "Performance_Test_151",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_151_retrospective"
  - Namespace: "wingman"
