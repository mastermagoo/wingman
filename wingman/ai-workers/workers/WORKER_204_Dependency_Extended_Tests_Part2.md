# Worker 204: Dependency Extended Tests Part2
...
- [ ] Test 305: Sidecar container dependencies
- [ ] Test 306: Init container dependencies
...
```bash
cd wingman && pytest tests/test_extended_204.py -v --tb=short
cd wingman && pytest tests/test_extended_204.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "204",
  "worker_name": "Dependency_Extended_Tests_Part2",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_204_retrospective"
  - Namespace: "wingman"
