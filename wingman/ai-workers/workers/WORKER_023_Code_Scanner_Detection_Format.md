# Worker 023: Code Scanner - Code Scanner Detection Format
...
**Focus:** JSON formatter for Code Scanner
...
- **Previous workers:** WORKER_022 (prior deliverable complete)
...
```bash
# Validation command for WORKER_023
...
{
  "worker_id": "023",
  "worker_name": "Code_Scanner_Detection_Format",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_023_retrospective"
  - Namespace: "wingman"
