# Worker 190: Semantic Extended Tests Part4
...
- [ ] Test 264: Complex multi-service orchestration
- [ ] Test 265: Cross-environment operations
...
```bash
cd wingman && pytest tests/test_extended_190.py -v --tb=short
cd wingman && pytest tests/test_extended_190.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "190",
  "worker_name": "Semantic_Extended_Tests_Part4",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_190_retrospective"
  - Namespace: "wingman"
