# Worker 120: Edge Case Tests 120
...
- [ ] Test 183: Network timeout to database
...
```bash
cd wingman && pytest tests/test_edge_cases_120.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_120.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "120",
  "worker_name": "Edge_Case_Tests_120",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_120_retrospective"
  - Namespace: "wingman"
