# Worker 124: Edge Case Tests 124
...
- [ ] Test 191: No space left on device
...
```bash
cd wingman && pytest tests/test_edge_cases_124.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_124.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "124",
  "worker_name": "Edge_Case_Tests_124",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_124_retrospective"
  - Namespace: "wingman"
