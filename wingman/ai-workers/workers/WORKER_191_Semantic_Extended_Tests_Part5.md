# Worker 191: Semantic Extended Tests Part5
...
- [ ] Test 267: Mixed language
- [ ] Test 268: Translation artifacts
...
```bash
cd wingman && pytest tests/test_extended_191.py -v --tb=short
cd wingman && pytest tests/test_extended_191.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "191",
  "worker_name": "Semantic_Extended_Tests_Part5",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_191_retrospective"
  - Namespace: "wingman"
