# Worker 203: Dependency Extended Tests Part1
...
- [ ] Test 302: Circular dependencies
- [ ] Test 303: Diamond dependencies
...
```bash
cd wingman && pytest tests/test_extended_203.py -v --tb=short
cd wingman && pytest tests/test_extended_203.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "203",
  "worker_name": "Dependency_Extended_Tests_Part1",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_203_retrospective"
  - Namespace: "wingman"
