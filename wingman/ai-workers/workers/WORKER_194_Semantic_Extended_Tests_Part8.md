# Worker 194: Semantic Extended Tests Part8
...
- [ ] Test 276: Failure recovery
- [ ] Test 277: Disaster recovery
...
```bash
cd wingman && pytest tests/test_extended_194.py -v --tb=short
cd wingman && pytest tests/test_extended_194.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "194",
  "worker_name": "Semantic_Extended_Tests_Part8",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_194_retrospective"
  - Namespace: "wingman"
