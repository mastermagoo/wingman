# Worker 199: Code Scanner Extended Tests Part4
...
- [ ] Create/update file: `wingman/tests/test_integration_199.py`
- [ ] Create test file: `wingman/tests/test_extended_199.py`
- [ ] Implement 3 tests: Tests 290-292
- [ ] Test 290: Git history manipulation
- [ ] Test 291: Force push detection
- [ ] Test 292: Branch deletion
...
```bash
cd wingman && pytest tests/test_extended_199.py -v --tb=short
cd wingman && pytest tests/test_extended_199.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "199",
  "worker_name": "Code_Scanner_Extended_Tests_Part4",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_199_retrospective"
  - Namespace: "wingman"
