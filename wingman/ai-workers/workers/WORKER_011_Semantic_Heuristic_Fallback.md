# Worker 011: Semantic Analyzer - Semantic Heuristic Fallback
...
- [ ] Rule-based scoring (word count, sections) when LLM fails
- [ ] Test results file: `ai-workers/results/worker-011-results.json`

**Focus:** Heuristic logic for Semantic Analyzer
...
- **Previous workers:** WORKER_010 (prior deliverable complete)
...
```bash
# Validation command for WORKER_011
...
{
  "worker_id": "011",
  "worker_name": "Semantic_Heuristic_Fallback",
  "status": "pass|fail",
...
- **Risk Level:** LOW
- **Impact if Failed:** Semantic analyzer fails when LLM unavailable
- **Probability of Failure:** <10% (Implement heuristic fallback)
- **Blast Radius:** Implement heuristic fallback only
...
- **Functionality:** Semantic analyzer reliability (no LLM) works as specified
...
- **Reasoning:** Heuristic logic is structured implementation
...
- **Store in mem0:**
  - Key: "wingman_worker_011_retrospective"
  - Namespace: "wingman"
