# Worker 008: Semantic Analyzer - Semantic Completeness Prompt
...
**Focus:** Prompt engineering for Semantic Analyzer
...
- **Previous workers:** WORKER_007 (prior deliverable complete)
...
```bash
# Validation command for WORKER_008
...
{
  "worker_id": "008",
  "worker_name": "Semantic_Completeness_Prompt",
  "status": "pass|fail",
...
- **Risk Level:** MINIMAL
- **Impact if Failed:** Completeness scoring unavailable
- **Probability of Failure:** <5% (Create completeness prompt)
- **Blast Radius:** Create completeness prompt only
...
- **Functionality:** Semantic completeness assessment works as specified
...
- **Reasoning:** Prompt engineering is structured implementation
...
- **Store in mem0:**
  - Key: "wingman_worker_008_retrospective"
  - Namespace: "wingman"
