# Worker 130: Edge Case Tests 130
...
- [ ] Create/update file: `wingman/tests/test_integration_130.py`
- [ ] Create test file: `wingman/tests/test_edge_cases_130.py`
- [ ] Implement 2 tests: Tests 202-203
- [ ] Test 202: Cache inconsistency
- [ ] Test 203: Stale cache data
...
```bash
cd wingman && pytest tests/test_edge_cases_130.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_130.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "130",
  "worker_name": "Edge_Case_Tests_130",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_130_retrospective"
  - Namespace: "wingman"
