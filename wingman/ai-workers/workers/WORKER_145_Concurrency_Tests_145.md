# Worker 145: Concurrency Tests 145
...
- [ ] Test 234: Transaction isolation SERIALIZABLE
...
```bash
cd wingman && pytest tests/test_concurrency_145.py -v --tb=short
cd wingman && pytest tests/test_concurrency_145.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "145",
  "worker_name": "Concurrency_Tests_145",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_145_retrospective"
  - Namespace: "wingman"
