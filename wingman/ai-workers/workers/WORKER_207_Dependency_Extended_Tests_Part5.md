# Worker 207: Dependency Extended Tests Part5
...
- [ ] Create/update file: `wingman/tests/test_integration_207.py`
- [ ] Create test file: `wingman/tests/test_extended_207.py`
- [ ] Implement 3 tests: Tests 313-315
- [ ] Test 313: Time-based dependencies
- [ ] Test 314: Scheduled job dependencies
- [ ] Test 315: Event-driven dependencies
...
```bash
cd wingman && pytest tests/test_extended_207.py -v --tb=short
cd wingman && pytest tests/test_extended_207.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "207",
  "worker_name": "Dependency_Extended_Tests_Part5",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_207_retrospective"
  - Namespace: "wingman"
