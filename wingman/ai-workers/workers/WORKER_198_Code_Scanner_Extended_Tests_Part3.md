# Worker 198: Code Scanner Extended Tests Part3
...
- [ ] Create/update file: `wingman/tests/test_integration_198.py`
- [ ] Create test file: `wingman/tests/test_extended_198.py`
- [ ] Implement 3 tests: Tests 287-289
- [ ] Test 287: Docker-in-Docker patterns
- [ ] Test 288: Privileged container operations
- [ ] Test 289: Host network access
...
```bash
cd wingman && pytest tests/test_extended_198.py -v --tb=short
cd wingman && pytest tests/test_extended_198.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "198",
  "worker_name": "Code_Scanner_Extended_Tests_Part3",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_198_retrospective"
  - Namespace: "wingman"
