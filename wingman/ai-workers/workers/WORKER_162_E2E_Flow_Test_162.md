...
```bash
cd wingman && pytest tests/test_e2e_162.py -v --tb=short
cd wingman && pytest tests/test_e2e_162.py --cov --cov-report=term-missing
```
...
- **Store in mem0:**
  - Key: "wingman_worker_162_retrospective"
  - Namespace: "wingman"
