# Worker 141: Concurrency Tests 141
...
- [ ] Test 226: Thread safety in database updates
...
```bash
cd wingman && pytest tests/test_concurrency_141.py -v --tb=short
cd wingman && pytest tests/test_concurrency_141.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "141",
  "worker_name": "Concurrency_Tests_141",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_141_retrospective"
  - Namespace: "wingman"
