# Worker 217: Gradual Rollout 10 Percent
...
- [ ] Create/update file: `wingman/deployment/deploy_217.sh`
...
{
  "worker_id": "217",
  "worker_name": "Gradual_Rollout_10_Percent",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_217_retrospective"
  - Namespace: "wingman"
