# Worker 147: Concurrency Tests 147
...
- [ ] Test 238: Connection cleanup after error
...
```bash
cd wingman && pytest tests/test_concurrency_147.py -v --tb=short
cd wingman && pytest tests/test_concurrency_147.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "147",
  "worker_name": "Concurrency_Tests_147",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_147_retrospective"
  - Namespace: "wingman"
