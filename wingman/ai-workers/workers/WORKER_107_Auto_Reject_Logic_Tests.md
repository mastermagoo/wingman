# Worker 107: Auto Reject Logic Tests

**Date:** 2026-01-13
**Environment:** TEST
**Phase:** 4.1 - Integration Tests Part 5
**Duration:** 20 minutes
...
- [ ] Create test file: `wingman/tests/test_integration_107.py`
- [ ] Implement 6 tests: Tests 149-154
- [ ] Test 149: Quality 50 → AUTO_REJECT
- [ ] Test 150: Quality 59 → AUTO_REJECT
- [ ] Test 151: Quality 60 → MANUAL (no reject)
- [ ] Test 152: CRITICAL risk → AUTO_REJECT
- [ ] Test 153: HIGH risk + quality 80 → MANUAL (no reject)
- [ ] Test 154: Edge cases at threshold boundaries
...
```bash
cd wingman && pytest tests/test_integration_107.py -v --tb=short
cd wingman && pytest tests/test_integration_107.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "107",
  "worker_name": "Auto_Reject_Logic_Tests",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_107_retrospective"
  - Namespace: "wingman"
...
- Tests Covered: 149, 150, 151, 152, 153, 154
