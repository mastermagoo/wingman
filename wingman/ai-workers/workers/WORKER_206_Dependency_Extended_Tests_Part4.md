# Worker 206: Dependency Extended Tests Part4
...
- [ ] Test 311: Database schema dependencies
- [ ] Test 312: Cache dependencies
...
```bash
cd wingman && pytest tests/test_extended_206.py -v --tb=short
cd wingman && pytest tests/test_extended_206.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "206",
  "worker_name": "Dependency_Extended_Tests_Part4",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_206_retrospective"
  - Namespace: "wingman"
