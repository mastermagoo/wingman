# Worker 036: Code Scanner - Code Scanner Tests Integration
...
- **Previous workers:** WORKER_035 (prior deliverable complete)
...
```bash
# Validation command for WORKER_036
...
{
  "worker_id": "036",
  "worker_name": "Code_Scanner_Tests_Integration",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_036_retrospective"
  - Namespace: "wingman"
