# Worker 009: Semantic Analyzer - Semantic Coherence Prompt
...
- **Previous workers:** WORKER_008 (prior deliverable complete)
...
```bash
# Validation command for WORKER_009
...
{
  "worker_id": "009",
  "worker_name": "Semantic_Coherence_Prompt",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_009_retrospective"
  - Namespace: "wingman"
