# Worker 110: Edge Case Tests 110
...
- [ ] Create/update file: `wingman/tests/test_integration_110.py`
- [ ] Create test file: `wingman/tests/test_edge_cases_110.py`
- [ ] Implement 2 tests: Tests 162-163
- [ ] Test 162: Empty/null inputs
- [ ] Test 163: Null instruction field
...
```bash
cd wingman && pytest tests/test_edge_cases_110.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_110.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "110",
  "worker_name": "Edge_Case_Tests_110",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_110_retrospective"
  - Namespace: "wingman"
