...
- [ ] Test 213: API key in instruction
...
```bash
cd wingman && pytest tests/test_security_135.py -v --tb=short
cd wingman && pytest tests/test_security_135.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "135",
  "worker_name": "Security_Tests_135",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_135_retrospective"
  - Namespace: "wingman"
