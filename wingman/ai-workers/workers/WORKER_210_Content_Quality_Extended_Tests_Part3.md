# Worker 210: Content Quality Extended Tests Part3
...
- [ ] Create/update file: `wingman/tests/test_integration_210.py`
- [ ] Create test file: `wingman/tests/test_extended_210.py`
- [ ] Implement 2 tests: Tests 322-323
- [ ] Test 322: Inconsistent terminology
- [ ] Test 323: Contradictory statements
...
```bash
cd wingman && pytest tests/test_extended_210.py -v --tb=short
cd wingman && pytest tests/test_extended_210.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "210",
  "worker_name": "Content_Quality_Extended_Tests_Part3",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_210_retrospective"
  - Namespace: "wingman"
