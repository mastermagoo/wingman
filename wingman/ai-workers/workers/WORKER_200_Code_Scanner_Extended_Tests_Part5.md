# Worker 200: Code Scanner Extended Tests Part5
...
- [ ] Test 294: Dependency installation
- [ ] Test 295: Unverified sources
...
```bash
cd wingman && pytest tests/test_extended_200.py -v --tb=short
cd wingman && pytest tests/test_extended_200.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "200",
  "worker_name": "Code_Scanner_Extended_Tests_Part5",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_200_retrospective"
  - Namespace: "wingman"
