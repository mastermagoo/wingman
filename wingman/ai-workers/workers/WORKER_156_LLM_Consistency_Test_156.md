# Worker 156: LLM Consistency Test 156
...
```bash
cd wingman && pytest tests/test_llm_consistency_156.py -v --tb=short
cd wingman && pytest tests/test_llm_consistency_156.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "156",
  "worker_name": "LLM_Consistency_Test_156",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_156_retrospective"
  - Namespace: "wingman"
