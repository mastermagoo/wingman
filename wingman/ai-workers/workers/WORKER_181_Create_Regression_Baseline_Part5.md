# Worker 181: Create Regression Baseline Part5
...
- [ ] Create/update file: `wingman/tests/test_integration_181.py`
- [ ] Capture baseline for instructions 41-50
- [ ] Store baseline/results in fixtures/regression/
- [ ] Test results file: `ai-workers/results/worker-181-results.json`

---

## 2. SUCCESS_CRITERIA

- [ ] Run validation on 10 instructions
...
{
  "worker_id": "181",
  "worker_name": "Create_Regression_Baseline_Part5",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_181_retrospective"
  - Namespace: "wingman"
