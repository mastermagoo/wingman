# Worker 208: Content Quality Extended Tests Part1
...
- [ ] Create/update file: `wingman/tests/test_integration_208.py`
- [ ] Create test file: `wingman/tests/test_extended_208.py`
- [ ] Implement 3 tests: Tests 316-318
- [ ] Test 316: Incomplete mitigation plans
- [ ] Test 317: Vague success criteria
- [ ] Test 318: Unclear deliverables
...
```bash
cd wingman && pytest tests/test_extended_208.py -v --tb=short
cd wingman && pytest tests/test_extended_208.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "208",
  "worker_name": "Content_Quality_Extended_Tests_Part1",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_208_retrospective"
  - Namespace: "wingman"
