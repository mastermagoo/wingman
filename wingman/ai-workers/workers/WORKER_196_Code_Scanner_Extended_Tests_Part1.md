# Worker 196: Code Scanner Extended Tests Part1
...
- [ ] Test 282: Base64 encoded strings
- [ ] Test 283: Hex encoded data
...
```bash
cd wingman && pytest tests/test_extended_196.py -v --tb=short
cd wingman && pytest tests/test_extended_196.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "196",
  "worker_name": "Code_Scanner_Extended_Tests_Part1",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_196_retrospective"
  - Namespace: "wingman"
