...
```bash
cd wingman && pytest tests/test_security_138.py -v --tb=short
cd wingman && pytest tests/test_security_138.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "138",
  "worker_name": "Security_Tests_138",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_138_retrospective"
  - Namespace: "wingman"
