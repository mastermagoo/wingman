# Worker 193: Semantic Extended Tests Part7
...
- [ ] Test 273: Scheduled tasks
- [ ] Test 274: Cron expressions
...
```bash
cd wingman && pytest tests/test_extended_193.py -v --tb=short
cd wingman && pytest tests/test_extended_193.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "193",
  "worker_name": "Semantic_Extended_Tests_Part7",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_193_retrospective"
  - Namespace: "wingman"
