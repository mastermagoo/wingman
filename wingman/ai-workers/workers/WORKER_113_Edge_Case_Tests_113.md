# Worker 113: Edge Case Tests 113
...
- [ ] Create/update file: `wingman/tests/test_integration_113.py`
- [ ] Create test file: `wingman/tests/test_edge_cases_113.py`
- [ ] Implement 2 tests: Tests 168-169
- [ ] Test 168: Malformed JSON in instruction
- [ ] Test 169: Invalid JSON structure
...
```bash
cd wingman && pytest tests/test_edge_cases_113.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_113.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "113",
  "worker_name": "Edge_Case_Tests_113",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_113_retrospective"
  - Namespace: "wingman"
