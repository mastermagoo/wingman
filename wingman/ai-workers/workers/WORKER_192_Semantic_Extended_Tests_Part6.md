# Worker 192: Semantic Extended Tests Part6
...
- [ ] Test 270: Inline scripts
- [ ] Test 271: Configuration snippets
...
```bash
cd wingman && pytest tests/test_extended_192.py -v --tb=short
cd wingman && pytest tests/test_extended_192.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "192",
  "worker_name": "Semantic_Extended_Tests_Part6",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_192_retrospective"
  - Namespace: "wingman"
