# Worker 131: Edge Case Tests 131
...
- [ ] Create/update file: `wingman/tests/test_integration_131.py`
- [ ] Create test file: `wingman/tests/test_edge_cases_131.py`
- [ ] Implement 2 tests: Tests 204-205
- [ ] Test 204: JWT token expiration
- [ ] Test 205: Capability token expiration
...
```bash
cd wingman && pytest tests/test_edge_cases_131.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_131.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "131",
  "worker_name": "Edge_Case_Tests_131",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_131_retrospective"
  - Namespace: "wingman"
