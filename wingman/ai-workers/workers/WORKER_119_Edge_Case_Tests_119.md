# Worker 119: Edge Case Tests 119
...
- [ ] Create/update file: `wingman/tests/test_integration_119.py`
- [ ] Create test file: `wingman/tests/test_edge_cases_119.py`
- [ ] Implement 2 tests: Tests 180-181
- [ ] Test 180: Invalid service reference
- [ ] Test 181: Non-existent service dependency
...
```bash
cd wingman && pytest tests/test_edge_cases_119.py -v --tb=short
cd wingman && pytest tests/test_edge_cases_119.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "119",
  "worker_name": "Edge_Case_Tests_119",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_119_retrospective"
  - Namespace: "wingman"
