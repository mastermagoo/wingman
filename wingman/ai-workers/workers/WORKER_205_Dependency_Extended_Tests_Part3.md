# Worker 205: Dependency Extended Tests Part3
...
- [ ] Create/update file: `wingman/tests/test_integration_205.py`
- [ ] Create test file: `wingman/tests/test_extended_205.py`
- [ ] Implement 3 tests: Tests 307-309
- [ ] Test 307: External service dependencies
- [ ] Test 308: Third-party API dependencies
- [ ] Test 309: Cloud service dependencies
...
```bash
cd wingman && pytest tests/test_extended_205.py -v --tb=short
cd wingman && pytest tests/test_extended_205.py --cov --cov-report=term-missing
```
...
{
  "worker_id": "205",
  "worker_name": "Dependency_Extended_Tests_Part3",
  "status": "pass|fail",
...
- **Store in mem0:**
  - Key: "wingman_worker_205_retrospective"
  - Namespace: "wingman"
